...
<div>
    <div class="container">
        <h2 class="text-center mt-3">Product Page</h2>
    </div>
    <div class="container d-flex">
        <div class="row d-flex product_div">
            <div class="col-12 col-md-6 col-sm-12 col-xl-6">
                ...
                <div class="d-flex justify-content-start mt-1">
                    <div class="p-2">
                        <a class="carousel-thumb active" data-slide-to="0" href="#carouselExample">
                            <img src="https://via.placeholder.com/150x100" class="img-thumbnail" alt="Thumb 1">
                        </a>
                    </div>
                    <div class="p-2">
                        <a class="carousel-thumb" data-slide-to="1" href="#carouselExample">
                            <img src="https://via.placeholder.com/150x100" class="img-thumbnail" alt="Thumb 2">
                        </a>
                    </div>
                    <div class="p-2">
                        <a class="carousel-thumb" data-slide-to="2" href="#carouselExample">
                            <img src="https://via.placeholder.com/150x100" class="img-thumbnail" alt="Thumb 3">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-sm-12 col-xl-6 align-self-center w3-padding-large">
                <div class="text-left">
                    <h1>DUSTBINS</h1>
                    ...
                    <h3><b>Rs 333</b></h3>
                    <button class="btn blue_button" type="button">Add to
                        Cart</button>
                    <p class="mt-3">The unassuming dustbin is a vital hero in maintaining a clean and healthy
                        environment. This
                        closed container, often made of metal or plastic, serves as the primary receptacle for our
                        waste.</p>
                </div>
            </div>
        </div>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button"
                    role="tab" aria-controls="contact" aria-selected="false">Reviews</button>
            </li>
        </ul>
                    ...
                    <div class="container-md mt-5 text-center">
                        <div class="row justify-content-center">
                            <div class="col-10 text-center">
                                <h4>Section 1</h4>
                                <p class="mt-4">Introducing Amazon Brand - Solimo Stainless Steel Perforated Dustbin
                                    with Rubber Base in elegant silver. This versatile bin serves as a sleek waste
                                    basket for dry office waste or a stylish laundry hamper for soiled clothes.
                                    Available in various sizes, it's ideal for any room. With a modern and practical
                                    design, the wide opening ensures easy trash disposal. Crafted from high-quality
                                    stainless steel with a rubber base, this solid open bin is an essential addition to
                                    your home, kitchen, or office. Keep your space tidy with Solimo's reliable and
                                    contemporary solution.</p>
                            </div>
                        </div>
                        <div class="d-flex mt-5">
                            <div class="w3-row d-flex flex-container">
                                <div class="w3-col s6 w3-center align-self-center">
                                    <div class="w3-center">
                                        <img class="w3-card-4 main_section_img" src="dustbin.jpg" />
                                    </div>
                                </div>
                                <div class="w3-col m6 w3-center align-self-center w3-padding-large">
                                    <div class="align-self-center">
                                        <h1>DUSTBINS</h1>
                                        <p>Introducing Amazon Brand - Solimo Stainless Steel Perforated Dustbin with
                                            Rubber Base in elegant silver. This versatile bin serves as a sleek waste
                                            basket for dry office waste or a stylish laundry hamper for soiled clothes.
                                            Available in various sizes, it's ideal for any room. With a modern and
                                            practical design, the wide opening ensures easy trash disposal. Crafted from
                                            high-quality stainless steel with a rubber base, this solid open bin is an
                                            essential addition to your home, kitchen, or office. Keep your space tidy
                                            with Solimo's reliable and contemporary solution.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-container">
                            <div class="w3-row d-flex reverse_section">
                                <div class="w3-col s6 w3-center align-self-center">
                                    <div class="w3-center">
                                        <img class="w3-card-4 main_section_img" src="dustbin.jpg" />
                                    </div>
                                ...
                                <div class="w3-col m6 w3-center align-self-center w3-padding-large">
                                    <div class="align-self-center">
                                        <h1>DUSTBINS</h1>
                                        <p>The unassuming dustbin is a vital hero in maintaining a clean and healthy
                                            environment. This closed container, often made of metal or plastic, serves
                                            as
                                            the
                                            primary receptacle for our waste.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        <div class="p-3 position-relative">
                                                            <div class="list-card-body">
                                                                ...
                                                                <p class="text-gray time mb-0"><a
                                                                        class="btn btn-link btn-sm pl-0 text-black pr-0"
                                                                        href="#">$250 </a> <span
                                                                        class="badge badge-primary">NEW</span> <span
                                                                        class="float-right">
                                                            ...
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <h6 class="mb-1">Honey Chilli Potato
                                                                        <span class="badge badge-success">Pure
                                                                            Veg</span>
                                                                    </h6>
                                                                    <p class="text-gray mb-0">$600</p>
                                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel"
                                            ...
                                            <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                                ...
                                                <p class="mb-2 text-black"><i
                                                        class="icofont-clock-time text-primary mr-2"></i> Today 11am –
                                                    5pm, 6pm – 11pm
                                                    <span class="badge badge-success"> OPEN NOW </span>
                                                </p>
                                                <hr class="clearfix">
                                                <p class="text-black mb-0">You can also check the 3D view by using our
                                                    menue map clicking here &nbsp;&nbsp;&nbsp; <a
                                                        class="text-info font-weight-bold" href="#">Venue Map</a></p>
                                                <hr class="clearfix">
                                                ...
                                                <div class="reviews-members pt-4 pb-4">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <div class="reviews-members-footer">
                                                                <a class="total-like" href="#"><i
                                                                        class="icofont-thumbs-up"></i> 88K</a> <a
                                                                    class="total-like" href="#"><i
